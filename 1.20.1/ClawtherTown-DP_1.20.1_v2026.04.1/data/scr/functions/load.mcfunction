...
scoreboard players set #server version 114
...
scoreboard players set #free death_loss 500
...
scoreboard players set #cooldown back.config 2

scoreboard players set #limit homes.config 1000
scoreboard players set #delay homes.config 20
scoreboard players set #cooldown homes.config 2
