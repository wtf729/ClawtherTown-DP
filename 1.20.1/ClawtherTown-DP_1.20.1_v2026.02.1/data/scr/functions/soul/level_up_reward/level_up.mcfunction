...
execute as @s[scores={soul_level=..30}] run tellraw @s {"text":"","extra":[{"text":"[","color":"gold","bold":true},{"text":"神鹰","color":"yellow","bold":true},{"text":"] ","color":"gold","bold":true},{"text":"你的","color":"aqua"},{"text":"灵魂等级","color":"light_purple"},{"text":"已提升至","color":"aqua"},{"score":{"name":"@s","objective":"soul_level"},"color":"light_purple"},{"text":"级!","color":"aqua"}]}
