kill @e[type=item,limit=1,distance=..1,nbt={Item:{id:"minecraft:emerald_block",Count:1b}}]
loot spawn ~ ~ ~ loot scr:combat/obsidian_netherite_sword/obsidian_netherite_sword_xiii_emerald
