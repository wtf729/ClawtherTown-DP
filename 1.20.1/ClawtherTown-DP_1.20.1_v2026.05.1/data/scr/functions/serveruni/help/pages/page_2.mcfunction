...
tellraw @s {"text":"","extra":[{"text":"          [","color":"yellow"},{"text":"6","color":"light_purple"},{"text":"] ","color":"yellow"},{"text":"在线奖励","underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger scrafthelp set 106"}}]}
...
tellraw @s {"text":"","extra":[{"text":"        > ","color":"light_purple"},{"text":"上一页","underlined":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/trigger scrafthelp set 1"}},{"text":"         > ","color":"light_purple"},{"text":"下一页","color":"dark_gray"}]}
tellraw @s {"text":"","extra":[{"text":"--------------------------------------------------","color":"dark_gray"}]}
