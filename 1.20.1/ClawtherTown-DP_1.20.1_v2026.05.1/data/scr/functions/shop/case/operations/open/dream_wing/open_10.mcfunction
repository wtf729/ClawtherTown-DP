...
execute as @s[scores={dream_wing=..9}] run tellraw @s {"text":"","extra":[{"text":"--------------------------------------------------\n","color":"dark_gray"},{"text":"[","color":"gold","bold":true},{"text":"行商鹰","color":"yellow","bold":true},{"text":"] ","color":"gold","bold":true},{"text":"开箱失败! ","color":"red"},{"text":"\n你现在只有","color":"yellow"},{"score":{"name":"@s","objective":"dream_wing"},"color":"green"},{"text":"件幻梦翎片","color":"green"},{"text":"! ","color":"yellow"},{"text":"无法支付","color":"yellow"},{"score":{"name":"@s","objective":"shop_case_amount"},"color":"red"},{"text":"件幻梦翎片","color":"red"},{"text":"的账单! ","color":"yellow"},{"text":"\n看来你得继续努力了!","color":"yellow"},{"text":"\n--------------------------------------------------","color":"dark_gray"}]}
execute as @s[scores={dream_wing=..9}] run playsound minecraft:entity.villager.no ambient @s ~ ~ ~
execute as @s[scores={cd_case=1..}] if entity @s[scores={dream_wing=10..}] at @s run function scr:right_click/tellraw/cd_case
execute as @s[scores={cd_case=0}] if entity @s[scores={dream_wing=10..}] at @s run function scr:shop/case/operations/open/dream_wing/payment_success
