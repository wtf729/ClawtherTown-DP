...
tellraw @a {"text":"","extra":[{"text":"[","color":"gold","bold":true},{"text":"邮递鹰","color":"yellow","bold":true},{"text":"] ","color":"gold","bold":true},{"text":"所有人获得了在线奖励 ","color":"#c9d1d9"},{"text":"[幻梦翎片]","color":"#7dff9a","bold":false},{"text":" ! ","color":"#c9d1d9"},{"text":"跳转至开箱界面","underlined":true,"color":"#4dd9ff","clickEvent":{"action":"run_command","value":"/trigger shop set 100099"}}]}
