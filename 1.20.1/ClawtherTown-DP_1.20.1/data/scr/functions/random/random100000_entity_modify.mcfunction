...
execute in minecraft:overworld store result score #random100000_entity_modify scr_random run data get block 0 318 0 Items[0].tag.AttributeModifiers[0].Amount
