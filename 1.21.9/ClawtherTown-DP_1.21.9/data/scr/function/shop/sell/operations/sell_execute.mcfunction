...
execute as @s[scores={shop_sell_item_sold=0,shop_sell_selected_item=10201},nbt={Inventory:[{id:"minecraft:coal",components:{"minecraft:item_name":"rare_coal"}}]}] run function scr:shop/sell/operations/sell_success
execute as @s[scores={shop_sell_item_sold=0,shop_sell_selected_item=10201}] unless entity @s[nbt={Inventory:[{id:"minecraft:coal",components:{"minecraft:item_name":"rare_coal"}}]}] run function scr:shop/sell/operations/sell_fail

execute as @s[scores={shop_sell_item_sold=0,shop_sell_selected_item=10202},nbt={Inventory:[{id:"minecraft:copper_ingot",components:{"minecraft:item_name":"rare_copper_ingot"}}]}] run function scr:shop/sell/operations/sell_success
execute as @s[scores={shop_sell_item_sold=0,shop_sell_selected_item=10202}] unless entity @s[nbt={Inventory:[{id:"minecraft:copper_ingot",components:{"minecraft:item_name":"rare_copper_ingot"}}]}] run function scr:shop/sell/operations/sell_fail

execute as @s[scores={shop_sell_item_sold=0,shop_sell_selected_item=10203},nbt={Inventory:[{id:"minecraft:iron_ingot",components:{"minecraft:item_name":"rare_iron_ingot"}}]}] run function scr:shop/sell/operations/sell_success
execute as @s[scores={shop_sell_item_sold=0,shop_sell_selected_item=10203}] unless entity @s[nbt={Inventory:[{id:"minecraft:iron_ingot",components:{"minecraft:item_name":"rare_iron_ingot"}}]}] run function scr:shop/sell/operations/sell_fail

execute as @s[scores={shop_sell_item_sold=0,shop_sell_selected_item=10204},nbt={Inventory:[{id:"minecraft:gold_ingot",components:{"minecraft:item_name":"rare_gold_ingot"}}]}] run function scr:shop/sell/operations/sell_success
execute as @s[scores={shop_sell_item_sold=0,shop_sell_selected_item=10204}] unless entity @s[nbt={Inventory:[{id:"minecraft:gold_ingot",components:{"minecraft:item_name":"rare_gold_ingot"}}]}] run function scr:shop/sell/operations/sell_fail

execute as @s[scores={shop_sell_item_sold=0,shop_sell_selected_item=10205},nbt={Inventory:[{id:"minecraft:diamond",components:{"minecraft:item_name":"rare_diamond"}}]}] run function scr:shop/sell/operations/sell_success
execute as @s[scores={shop_sell_item_sold=0,shop_sell_selected_item=10205}] unless entity @s[nbt={Inventory:[{id:"minecraft:diamond",components:{"minecraft:item_name":"rare_diamond"}}]}] run function scr:shop/sell/operations/sell_fail

execute as @s[scores={shop_sell_item_sold=0,shop_sell_selected_item=10206},nbt={Inventory:[{id:"minecraft:emerald",components:{"minecraft:item_name":"rare_emerald"}}]}] run function scr:shop/sell/operations/sell_success
execute as @s[scores={shop_sell_item_sold=0,shop_sell_selected_item=10206}] unless entity @s[nbt={Inventory:[{id:"minecraft:emerald",components:{"minecraft:item_name":"rare_emerald"}}]}] run function scr:shop/sell/operations/sell_fail
