...
execute as @a at @s as @e[type=minecraft:item,distance=..5,nbt={Item:{id:"minecraft:iron_nugget",components:{"minecraft:item_name":"soul"}}}] run function scr:soul/count/soul_ground_count
execute as @a at @s as @e[type=minecraft:item,distance=..5,nbt={Item:{id:"minecraft:iron_nugget",components:{"minecraft:item_name":"soul_plus"}}}] run function scr:soul/count/soul_plus_ground_count
