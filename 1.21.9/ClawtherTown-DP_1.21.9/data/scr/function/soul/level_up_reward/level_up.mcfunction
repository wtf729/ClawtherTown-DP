...
execute as @s[scores={soul_level=..50}] run tellraw @s {"text":"","extra":[{"text":"你的","color":"aqua"},{"text":"灵魂等级","color":"light_purple"},{"text":"已提升至","color":"aqua"},{"score":{"name":"@s","objective":"soul_level"},"color":"light_purple"},{"text":"级!","color":"aqua"}]}
execute as @s[scores={soul_level=51..}] run tellraw @a {"text":"","extra":[{"selector":"@s"},{"text":"经过不懈努力, ","color":"yellow"},{"text":"灵魂等级","color":"light_purple"},{"text":"已提升至","color":"yellow"},{"score":{"name":"@s","objective":"soul_level"},"color":"light_purple"},{"text":"级!","color":"yellow"}]}
