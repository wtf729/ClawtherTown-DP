#help
execute if score @s scrhelp matches 1 run function scr:server_unique/help/pages/page_1
execute if score @s scrhelp matches 2 run function scr:server_unique/help/pages/page_2

execute if score @s scrhelp matches 101 run function scr:server_unique/help/help1
execute if score @s scrhelp matches 102 run function scr:server_unique/help/help2
execute if score @s scrhelp matches 103 run function scr:server_unique/help/help3
