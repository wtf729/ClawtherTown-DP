...
execute as @a at @s as @e[type=minecraft:item,distance=..5,nbt={Item:{id:"minecraft:gold_nugget",components:{"minecraft:item_name":"clawther_coin"}}}] run function scr:clawther_coin/count/clawther_coin_ground_count
execute as @a at @s as @e[type=minecraft:item,distance=..5,nbt={Item:{id:"minecraft:gold_nugget",components:{"minecraft:item_name":"clawther_coin_plus"}}}] run function scr:clawther_coin/count/clawther_coin_plus_ground_count
