...
tellraw @s {"text":"","extra":[{"text":"正在","color":"yellow"},{"text":"开启","color":"yellow"},{"text":"[","color":"yellow"},{"translate":"item.scr.case_special_item_i","bold":false,"color":"yellow"},{"text":"]","color":"yellow"},{"text":"!","color":"yellow"}]}