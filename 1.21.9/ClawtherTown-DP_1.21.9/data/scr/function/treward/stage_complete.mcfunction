...
tellraw @a {"text":"","extra":[{"text":"[","color":"gold","bold":true},{"text":"邮递鹰","color":"yellow","bold":true},{"text":"] ","color":"gold","bold":true},{"text":"所有人获得了在线奖励 ","color":"#e5e6a7"},{"text":"[幻梦翎片]","color":"green","bold":false},{"text":" ! ","color":"#e5e6a7"},{"text":"跳转至开箱界面","underlined":true,"color":"aqua","click_event":{"action":"run_command","command":"/trigger shop set 100099"}}]}
execute as @a at @s run tellraw @s {"text":"","extra":[{"text":"[","color":"gold","bold":true},{"text":"邮递鹰","color":"yellow","bold":true},{"text":"] ","color":"gold","bold":true},{"text":"当前为 ","color":"#e5e6a7"},{"text":"第 ","color":"#1ddddd"},{"score":{"name":"#treward_cycle","objective":"treward"},"color":"#e5e6a7"},{"text":" 周期","color":"#1ddddd"},{"text":" 第 ","color":"#1ddddd"},{"score":{"name":"#treward_stage","objective":"treward"},"color":"#e5e6a7"},{"text":"/","color":"#1ddddd"},{"text":"9","color":"gold"},{"text":" 次 ","color":"#1ddddd"},{"text":"奖励邮递! ","color":"#e5e6a7"},{"text":"本周期你参加了","color":"#e5e6a7"},{"score":{"name":"@s","objective":"treward_mark"},"color":"gold"},{"text":"次!","color":"#e5e6a7"}]}
