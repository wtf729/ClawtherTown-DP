...
execute as @s[scores={cd_case=1..}] if entity @s[scores={dream_wing=1..}] at @s run function scr:right_click/tellraw/cd_case
execute as @s[scores={cd_case=0}] if entity @s[scores={dream_wing=1..}] at @s run function scr:shop/case/operations/open/dream_wing/payment_success
