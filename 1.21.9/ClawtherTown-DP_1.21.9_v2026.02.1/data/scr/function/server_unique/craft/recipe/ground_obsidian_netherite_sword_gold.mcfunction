kill @e[type=minecraft:item,limit=1,distance=..1,nbt={Item:{id:"minecraft:gold_block",count:1}}]
loot spawn ~ ~ ~ loot scr:combat/obsidian_netherite_sword/obsidian_netherite_sword_gold
